...
const Section5 = () => {
  return (
  <>
  <div className=' flex flex-col gap-4 font-sans text-center pt-5'>
  ...
  <div className=' grid sm:grid-cols-2 lg:grid-cols-2 gap-12 -mt-8  px-20'>
  <div className= 'flex flex-col '>
    <img className=' h-20 w-20 ml-56'  src={Img1} alt='img1'/>
  ...
  <div className= 'flex flex-col '>
    <img className=' h-20 w-20 ml-56'  src={Img2} alt='img2'/>
  ...
  <div className= 'flex flex-col '>
    <img className=' h-20 w-20 ml-56'  src={Img3} alt='img3'/>
  ...
  <div className= 'flex flex-col '>
    <img className=' h-20 w-20 ml-56'  src={Img4} alt='img4'/>
