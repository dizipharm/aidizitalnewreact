...
const Section5 = () => {
  ...
  <div className= 'flex flex-col  '>
    <img className=' h-20 w-20 lg:ml-56 md:ml-96 sm:ml-12'  src={Img1} alt='img1'/>
  ...
  <div className= 'flex flex-col '>
    <img className=' h-20 w-20 lg:ml-56 md:ml-96 sm:ml-12'  src={Img2} alt='img2'/>
  ...
  <div className= 'flex flex-col '>
    <img className=' h-20 w-20 lg:ml-56 md:ml-96 sm:ml-12'  src={Img3} alt='img3'/>
  ...
  <div className= 'flex flex-col '>
    <img className=' h-20 w-20 lg:ml-56 md:ml-96 sm:ml-12'  src={Img4} alt='img4'/>
