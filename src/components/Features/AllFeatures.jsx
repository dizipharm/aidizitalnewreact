...
const AllFeatures = () => {
  return (
    <div name="features" className="w-full h-screen bg-white flex flex-col ">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 mt-12 pt-4">
          <div className="flex">
            <div>
          ...
          <div className="flex">
            ...
            <div>
              ...
              <p className="text-lg pt-2 pb-4">
              Integrations with EDI's and ARP systems into software applications enables them to exchange information and perform tasks that would be difficult without this communication.
              </p>
            </div>
          </div>
          <div className="flex">
