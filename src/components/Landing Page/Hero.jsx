...
const Hero = () => {
  return (
    <div name='home' className='w-full min-h-screen bg-[url("./assets/banner2.jpg")]  bg-no-repeat bg-cover flex flex-col justify-between ' >
       ...
       <div className="absolute inset-0 flex ">
        <div className='grid md:grid-cols-2  max-w-[1240px] m-auto'>
          ...
          <Link to='/contact'>
                <button type="button" className="bg-transparent gap-4 flex border-[#fbfcfc] p-2 text-white"  >
