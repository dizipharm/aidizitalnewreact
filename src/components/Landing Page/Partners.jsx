...
<Link to='https://www.tracepharm.com/' className=' '>
       ...
       <Link to='https://www.tcubeai.com' > <img className=' w-60 h-16' src={Tcube} alt='tcube'/></Link>
...
<Link to='https://www.tcubeai.com' className=' lg:pt-12 sm:pt-1' >
          <button type="button" className="bg-[#17b1b1] gap-4 flex border-[#17b1b1] p-2  text-white  ">
            Know More  <BsArrowRight className=' ml-4 mt-1'/>
        </button></Link>
       </div>
