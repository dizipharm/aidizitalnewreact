...
const Nft = () => {
  return (
    <>
    <Navbar/>
    <div name='home' className='w-full h-screen relative bg-[url("./assets/nft_banner.jpg")] bg-[50%]   bg-no-repeat bg-cover flex flex-col justify-between ' >
        <div className='grid md:grid-cols-2  max-w-[1240px] m-auto'>
            <div className='flex flex-col mt-10  justify-center md:items-start w-full px-2 py-8'>
                ...
                <h1 className='py-3 mt-20 text-3xl md:text-5xl font-bold text-white flex flex-col'>NFT </h1>
